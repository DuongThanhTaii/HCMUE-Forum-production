...
public partial class AddChatSafetyAndUserBlocks : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            """
            DROP TABLE IF EXISTS chat.message_reports;
            DROP TABLE IF EXISTS chat.conversation_mutes;
            DROP TABLE IF EXISTS identity.user_blocks;
            """);
    }
}
