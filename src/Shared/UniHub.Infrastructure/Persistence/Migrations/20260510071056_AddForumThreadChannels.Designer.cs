...
namespace UniHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260510071056_AddForumThreadChannels")]
    partial class AddForumThreadChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniHub.Forum.Domain.Posts.Post", b =>
                {
                    ...
                    b.Property<Guid?>("ThreadChannelId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UniHub.Forum.Domain.ThreadChannels.ThreadChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AllowAcceptedAnswers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("allow_accepted_answers");

                    b.Property<bool>("AllowModeratorActions")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("allow_moderator_actions");

                    b.Property<bool>("AllowPinnedComments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                    ...
                    b.ToTable("thread_channels", "forum");
                });
            ...
            modelBuilder.Entity("UniHub.Forum.Domain.Posts.Post", b =>
                {
                    b.HasOne("UniHub.Forum.Domain.ThreadChannels.ThreadChannel", null)
                        .WithMany()
