...
{
    /// <inheritdoc />
    public partial class NotificationPhase1Init : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PushContent = table.Column<string>(type: "text", nullable: true),
                    InAppContent = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTemplates_Status",
                table: "NotificationTemplates",
                column: "Status");
        }
