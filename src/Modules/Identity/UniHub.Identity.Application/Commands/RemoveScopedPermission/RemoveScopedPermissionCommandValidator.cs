...
internal sealed class RemoveScopedPermissionCommandValidator : AbstractValidator<RemoveScopedPermissionCommand>
{
    public RemoveScopedPermissionCommandValidator()
    {
        RuleFor(x => x.RoleId)
            .NotEmpty()
