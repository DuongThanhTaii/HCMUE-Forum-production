...
internal sealed class RevokeGroupPermissionOverrideCommandValidator : AbstractValidator<RevokeGroupPermissionOverrideCommand>
{
    public RevokeGroupPermissionOverrideCommandValidator()
    {
        RuleFor(x => x.GroupId)
            .NotEmpty()
