...
import { useGetForumCategoriesQuery, useGetPopularForumTagsQuery } from '../api/forum.list.api';
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-10">
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-lg text-slate-600">
          Discover new ideas, ask questions, and collaborate with the community.
        </p>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-bold text-slate-900">Browse Areas</h2>
            </div>
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-center gap-4 text-xs font-medium text-slate-500">
                      <div className="flex items-center gap-1.5 bg-slate-50 px-2 py-1 rounded-md">
                        ...
                        <span>{category.postCount} topics</span>
                      </div>
                    </div>
                  </Link>
                ))}
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="space-y-4">
              {/* Mock Trending Data - Ideally driven by API */}
              <div className="flex items-start gap-3 group cursor-pointer">
                <span className="text-slate-300 font-bold text-lg">01</span>
                <div>
                  <h4 className="font-medium text-slate-800 text-sm group-hover:text-primary line-clamp-2">How to ace the upcoming computer architecture exam?</h4>
                  <span className="text-xs text-slate-500">128 replies • 1.2k views</span>
                </div>
              </div>
              <div className="flex items-start gap-3 group cursor-pointer">
                <span className="text-slate-300 font-bold text-lg">02</span>
                <div>
                  <h4 className="font-medium text-slate-800 text-sm group-hover:text-primary line-clamp-2">Looking for a study group for Advanced Calculus</h4>
                  <span className="text-xs text-slate-500">45 replies • 800 views</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="font-bold text-slate-900">Popular Tags</h2>
            </div>
            {isLoadingTags ? (
